...
const listeningContent = {
  ...
  description:
    'Listen to these scenarios and identify which type of memory is being used.',
  scenarios: [
    {
      ...
      explanation:
        'This is a personal event from the past with specific details and emotions.',
    },
    {
      ...
      explanation:
        'This is a motor skill performed automatically without conscious thought.',
    },
    {
      text: 'Sarah knows that the capital of France is Paris and that water boils at 100°C.',
      answer: 'Semantic Memory',
      explanation:
        'These are general facts about the world, independent of personal experience.',
    },
  ],
};
...
const speakingTopics = [
  {
    ...
    prompt:
      'Share one of your most vivid episodic memories. Describe the event, the emotions you felt, and why you think this memory has stayed with you.',
    tips: [
  ...
  },
  {
    ...
    prompt:
      'Explain the difference between episodic, semantic, and procedural memory to a classmate. Give at least one example for each type.',
    tips: [
  ...
  },
  {
    ...
    prompt:
      'Discuss how you use all three types of memory in a typical school day. Provide specific examples.',
    tips: [
      'Think about different activities',
      'Connect to learning',
      'Reflect on automatic behaviors',
    ],
  },
];
...
const writingPrompts = [
  {
    ...
    prompt:
      'Write a short essay comparing episodic memory and semantic memory. Discuss their definitions, characteristics, and provide examples of each.',
    wordCount: '200-300 words',
  },
  {
    title: 'Reflection Writing',
    prompt:
      'Describe a time when your procedural memory helped you in a challenging situation. How did your automatic skills benefit you?',
    wordCount: '150-200 words',
  },
  {
    title: 'Analytical Paragraph',
    prompt:
      "Explain why memory is described as 'the database of a computer' for humans. What would life be like without memory?",
        ...
        <div className='container mx-auto px-4'>
          <div className='max-w-3xl'>
            ...
            <p className='text-primary-foreground/80 text-lg'>
              Comprehensive learning resources covering Reading, Writing,
                        ...
                        <div className='prose prose-slate max-w-none'>
                          {section.content
                            ...
                            .map((paragraph, pIndex) => (
                              <p
                                key={pIndex}
                                className='text-foreground/80 mb-4 last:mb-0 whitespace-pre-line'
                              >
                                {paragraph}
                              </p>
                            ))}
